...
class InviteCollaboratorServiceImpl(
    ...
    @Transactional
    override fun create(presenter: InviteCollaboratorPresenter, request: InviteCollaboratorService.RequestModel) {
        ...
        presenter.prepareSuccessView(
            InviteCollaboratorService.ResponseModel(
                request.usernameCollaborator, userCollaboratorCredentials.email,
