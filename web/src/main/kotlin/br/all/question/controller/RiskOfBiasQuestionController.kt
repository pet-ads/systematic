...
import br.all.question.presenter.riskOfBias.RestfulDeleteRoBQuestionPresenter
...
class RiskOfBiasQuestionController(
    ...
    @Operation(summary = "Create a risk of bias pick-many question in the protocol")
    @ApiResponses(
        value = [
    ...
    fun deleteQuestion(
        ...
        val presenter = RestfulDeleteRoBQuestionPresenter(linksFactory)
